...
{
    [TestClass]
    public class OccupancyControllerGetAPatientDetails
    {
        [TestMethod]
        public void OccupancyControllerGetAPatientDetailsTest()
        {
            RestClient restClient = new RestClient("http://localhost:53133/api/");
